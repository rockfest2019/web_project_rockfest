...
public enum CommandType {
	...
	FIND_ALL_COMPOSITIONS (new Command(CompositionService.getInstance()::findCompositions,PageType.COMPOSITIONS)),
	FIND_ALL_GENRES (new Command(GenreService.getInstance()::findGenres, PageType.GENRES)),
	FIND_ALL_SINGERS (new Command(SingerService.getInstance()::findSingers, PageType.SINGERS)),
